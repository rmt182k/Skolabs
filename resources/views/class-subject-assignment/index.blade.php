    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                {{-- DIBUNGKUS DIV AGAR FLEXBOX TETAP RAPI --}}
                <div>
                    <h5 class="card-title mb-0 d-inline-block">Teaching Assignment List</h5>
                    {{-- ELEMEN BARU UNTUK MENAMPILKAN TAHUN AKADEMIK --}}
                    <h6 id="academic-year-display" class="text-muted fw-normal ms-2"></h6>
                </div>
            ...
            <div class="card-body">
                ...
                <div id="assignment-card-view" class="d-none">
