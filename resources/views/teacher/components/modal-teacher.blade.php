{{-- File: resources/views/teacher/components/modal-teacher.blade.php --}}
            ...
            <div class="modal-body p-4">
                <form id="teacherForm" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="teacherPhoneNumber" name="phone_number">
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="teacherStatus" name="status" class="form-select" required>
